...
function makeToSignalEqual(userEquality = Object.is) {
  return (a2, b) => a2.kind === 1 && b.kind === 1 && userEquality(a2.value, b.value);
}

// node_modules/@jsverse/utils/index.esm.js
function n(r) {
...
var TRANSLOCO_LOADER = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_LOADER" : "");
var TRANSLOCO_CONFIG = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_CONFIG" : "", {
...
var TRANSLOCO_TRANSPILER = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_TRANSPILER" : "");
...
var FunctionalTranspiler = class _FunctionalTranspiler extends DefaultTranspiler {
  ...
  transpile(_a) {
    ...
    if (t(value)) {
      transpiled = value.replace(functionalCallRegExp, (match, functionName, args) => {
        try {
          const func = this.injector.get(functionName);
          const transpiledArgs = this.transpile(__spreadValues({
...
var TRANSLOCO_MISSING_HANDLER = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_MISSING_HANDLER" : "");
...
var TRANSLOCO_INTERCEPTOR = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_INTERCEPTOR" : "");
...
var TRANSLOCO_FALLBACK_STRATEGY = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_FALLBACK_STRATEGY" : "");
var DefaultFallbackStrategy = class _DefaultFallbackStrategy {
  ...
  getNextLangs() {
    ...
    if (!fallbackLang) {
      let message;
      if (typeof ngDevMode !== "undefined" && ngDevMode) {
        message = "When using the default fallback, a fallback language must be provided in the config!";
      } else {
        message = formatTranslocoError(
          4
...
var TranslationLoadError = class _TranslationLoadError extends Error {
  lang;
  fallbackLangs;
  isScope;
  ...
  constructor(lang, fallbackLangs, isScope) {
    ...
    Object.setPrototypeOf(this, _TranslationLoadError.prototype);
  }
};
...
var TRANSLOCO_LANG = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_LANG" : "");
var TRANSLOCO_LOADING_TEMPLATE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_LOADING_TEMPLATE" : "");
var TRANSLOCO_SCOPE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_SCOPE" : "");
...
var TRANSLOCO_TEST_LANGS = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_TEST_LANGS - Available testing languages" : "");
var TRANSLOCO_TEST_OPTIONS = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TRANSLOCO_TEST_OPTIONS - Testing options" : "");
