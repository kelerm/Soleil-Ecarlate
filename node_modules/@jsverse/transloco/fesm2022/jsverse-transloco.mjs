...
/* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'TRANSLOCO_LOADER' : '');

const TRANSLOCO_CONFIG = 
/* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'TRANSLOCO_CONFIG' : '', {
...
/* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'TRANSLOCO_TRANSPILER' : '');
            ...
            transpiled = value.replace(functionalCallRegExp, (match, functionName, args) => {
                try {
                    ...
                    if (typeof ngDevMode !== 'undefined' && ngDevMode) {
                        ...
                        message = formatTranslocoError(2 /* TranslocoErrorCode.FunctionalTranspilerInvalidSyntax */);
                    }
...
/* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode
    ...
    getNextLangs() {
        ...
        if (!fallbackLang) {
            ...
            if (typeof ngDevMode !== 'undefined' && ngDevMode) {
                ...
                message = formatTranslocoError(4 /* TranslocoErrorCode.NoFallbackLanguageProvided */);
            }
            throw new Error(message);
        }
...
const TRANSLOCO_LANG = /* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'TRANSLOCO_LANG' : '');
...
/* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'TRANSLOCO_SCOPE' : '');
...
const TRANSLOCO_TEST_LANGS = /* @__PURE__ */ new InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode
